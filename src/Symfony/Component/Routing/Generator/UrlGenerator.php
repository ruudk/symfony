...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    public function generate(string $name, array $parameters = [], int $referenceType = self::ABSOLUTE_PATH): string
    {
        ...
        return $this->doGenerate($variables, $defaults, $route->getRequirements(), $compiledRoute->getTokens(), $parameters, $name, $referenceType, $compiledRoute->getHostTokens(), $route->getSchemes(), '' !== $route->getPort() ? (int) $route->getPort() : null);
    }
