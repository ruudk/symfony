...
trait CompiledUrlMatcherTrait
{
    ...
    private function doMatch(string $pathinfo, array &$allow = [], array &$allowSchemes = []): array
    {
        ...
        foreach ($this->staticRoutes[$trimmedPathinfo] ?? [] as [$ret, $requiredHost, $requiredMethods, $requiredSchemes, $hasTrailingSlash, , $condition, $requiredPort]) {
            if ($requiredHost) {
            ...
            if ($hasRequiredScheme && null !== $requiredPort && $requiredPort !== $context->getPort()) {
                continue;
            }
        ...
        foreach ($this->regexpList as $offset => $regex) {
            while (preg_match($regex, $matchedPathinfo, $matches)) {
                foreach ($this->dynamicRoutes[$m = (int) $matches['MARK']] as [$ret, $vars, $requiredMethods, $requiredSchemes, $hasTrailingSlash, $hasTrailingVar, $condition, $requiredPort]) {
                    ...
                    if (null !== $requiredPort && $requiredPort !== $context->getPort()) {
                        continue;
                    }
